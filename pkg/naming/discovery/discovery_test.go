...
import (
	...
	"github.com/CloudZou/punk/pkg/net/http/blademaster"
	"os"
	"testing"
	"time"
...
func TestMain(m *testing.M) {
	feature2.DefaultGate.AddFlag(flag.CommandLine)
...
func TestDiscoverySelf(t *testing.T) {
	Convey("test TestDiscoverySelf ", t, func() {
		So(feature2.DefaultGate.Enabled(_selfDiscoveryFeatrue), ShouldBeTrue)
		d := New(c)
